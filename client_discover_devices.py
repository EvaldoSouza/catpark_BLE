...
def list_devices_found():
    #quero colocar aqui o tipo de endereço também!
    print("Full list of devices",len(devices),"discovered:")
    print("------------------------------")
    for path in devices:
        dev = devices[path]
        print("Address: " + bluetooth_utils.dbus_to_python(dev['Address']) + " AddressType: " + bluetooth_utils.dbus_to_python(dev['AddressType']))
        uuid = dev['UUIDs']
        for role in uuid:
            print("UUIDs of this device:" + role)
